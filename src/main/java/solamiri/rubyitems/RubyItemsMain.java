...
import solamiri.rubyitems.block.RubyOres;
...
public class RubyItemsMain implements ModInitializer {
	...
	public static final Logger LOGGER = LogManager.getLogger("rubyitems");
	public static final String MOD_ID = "rubyitems";
